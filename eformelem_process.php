...
$extension = isset($_POST['extension']) ? $_POST['extension'] : null;
    ...
    $track = !empty($_POST['track']) ? $_POST['track'] : 'N/A';
    $strand = !empty($_POST['strand']) ? $_POST['strand'] : 'N/A';
    $schname = !empty($_POST['schname']) ? $_POST['schname'] : 'N/A';
    $schaddress = !empty($_POST['schaddress']) ? $_POST['schaddress'] : 'N/A';
    $yrcomp = !empty($_POST['yrcomp']) ? $_POST['yrcomp'] : 'N/A';
    
    $schnamej = !empty($_POST['schnamej']) ? $_POST['schnamej'] : 'N/A';
    $schaddressj = !empty($_POST['schaddressj']) ? $_POST['schaddressj'] : 'N/A';
    $yrcompj = !empty($_POST['yrcompj']) ? $_POST['yrcompj'] : 'N/A';
